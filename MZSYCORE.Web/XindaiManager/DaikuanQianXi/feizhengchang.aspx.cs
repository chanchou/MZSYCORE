...
{
    public partial class feizhengchang : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = bll_xdxt_business_duebill.GetYuQiList("benjinyuqi", "MANAGEUSERID");
        ...
        {
            return bll_xdxt_business_duebill.GetSum(ziduan,"benjinyuqi");
        }
        /// <summary>
        /// 根据字段计数
        /// </summary>
        ...
        {
            return bll_xdxt_business_duebill.GetCount(ziduan,"benjinyuqi");
        }
        ...
        /// <returns></returns>
        protected string Bind_Depart(object obj)
        {
